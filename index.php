...
class Commentaire
{
    ...
    private ?string $nomAuteur;       // champ joint (lecture seule)
    private ?string $titreMemoire;    // champ joint (lecture seule)
    ...
    /**
     * Retourne le contenu nettoyé (sécurité XSS).
     */
    ...
    //  Représentation tableau (utile pour JSON/API)
...
switch ($_SESSION['user_role']) {
    ...
    case ROLE_TECHNICIEN:
        header('Location: /views/technicien/dashboard.php');
        break;
    default:
        header('Location: /views/auth/login.php');
}
