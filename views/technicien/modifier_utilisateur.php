...
<div class="container mt-4">
  ...
  <form method="POST" action="/controllers/TechnicienController.php" onsubmit="return confirm('Supprimer définitivement cet utilisateur ? Cette action est irréversible.');">
